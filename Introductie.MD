...
Wij zijn gefocused op de ontwikkeling van duurzame telefoons met geintegreerde zonnepaneel technologie. Dit om de duurzaamheid te bevorderen en de ervaring van de klant te vergemakkelijken.

### _Visie_
Wij streven naar een toekomst waarbij technologie en duurzaamheid hand in hand gaan. Ook werken wij toe naar een positie als marktleider in solar-powered mobiele aparaten om zo een positieve impact af te kunnen dragen op het milieu en het leven van de eindgebruikers

### _Strategie_
Om zowel de missie als de visie van SolMate te kunnen realiseren richten wij ons op een aantal belangerijke kernpunten: 
- Duurzaam productontwerp: Door het gebruik van milieuvriendelijke en effiente  materialen leveren wij onze producten met een minimale voetafdruk.
- Innovatie: Wij investeren ontinu in onderzoek en doorontwikkeling om de nieuwste trends in solar tech bij te houden en te implementeren.
...
Gerichte doelgroep: Wij zijnn gericht op een bepaalde groep die extra baat zal hebben bij onze diensten. Denk hierbij aan reizigers, outdoor liefhebbers en mensen in buitengebieden met beperkte toegang tot electriciteit. 
...
- Investeerders: Deze mensen hebben geld gestoken in SolMate en verwachten dus ook een groei van het bedrijf met het bijbehorende rendement

### 📊 Stakeholderanalyse – SolMate

| **Stakeholder**        | **Rol**                   | **Belangen**                                                | **Invloed** | **Betrokkenheid** | **Communicatiestrategie**              |
|------------------------|---------------------------|-------------------------------------------------------------|-------------|--------------------|-----------------------------------------|
| Eindgebruiker          | Klant / gebruiker          | Gebruiksgemak, duurzaamheid, batterijduur                   | Hoog        | Hoog               | Feedbackrondes, testen, enquêtes        |
| Projectteam            | Ontwikkeling               | Duidelijke eisen, haalbare doelen                           | Hoog        | Hoog               | Dagelijks contact, scrums, reviews       |
| Product owner          | Richting & planning        | Voldoen aan visie, tijdige oplevering                       | Hoog        | Hoog               | Intensieve samenwerking, roadmap        |
| Marketingteam          | Promotie & positionering   | Heldere USP’s, klantdata                                    | Middel      | Middel             | Input bij    |
| Investeerders          | Financiering               | Rendement, groeipotentie                                    | Hoog        | Laag               | Kwartaalrapportage, demo’s              |
     |
### Organogram

Dit is onze organogram die weergeeft hoe onze organisatie in elkaar steekt. SolMate is natuurlijk een klein bedrijf met een klein aantal werknemers vandaar dat de 
<pre>
                            CEO
                             |
        +--------------------+--------------------+
...
Legenda: 
De CEO (Chief Executive Officer) staat bovenaan en is eindverantwoordelijk.
	•	De CFO (Chief Financial Officer) beheert de financiën.
	•	De COO (Chief Operating Officer) is verantwoordelijk voor de operaties.
	•	Marketing valt direct onder de CEO en stuurt HR aan 
